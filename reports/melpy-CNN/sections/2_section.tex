...
\end{split} \\
&= \frac{\partial}{\partial x^{l}_{m',n'}}\big(\phi(x^{l}_{m',n'})\cdot w^{l}_{i,j}\big)\\
&= w^{l}_{i,j}\cdot \frac{\partial}{\partial x^{l}_{m',n'}}\big(\phi(x^{l}_{m',n'})\big)\\
&= w^{l}_{i,j}\cdot \phi'(x^{l}_{m',n'})\\
\implies \frac{\partial L}{\partial x^{l}_{m',n'}} &=  \sum_{j=0}^{k-1}\sum_{i=0}^{k-1}\delta^{l+1}_{m'-i,n'-j}\cdot w^{l}_{i,j}\cdot \phi'(x^{l}_{m',n'})\\
