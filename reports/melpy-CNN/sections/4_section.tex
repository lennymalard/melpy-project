...
\begin{tabular}{l|c c c c c c c|}
    ...
    \multicolumn{1}{|l|}{$1$}      & 201 226              & $1C_{w, b}+2D_{w,b} = 3$     & 15            & 02min 23sec       & 256     & $1^{-4}$             &35min 58sec           \\ 
    \multicolumn{1}{|l|}{$1$}      & 806 394              & $2C_{w, b}+2D_{w,b} = 4$     & 15            & 01min 53sec       & 256     & $1^{-4}$             &28min 22sec           \\ 
    \multicolumn{1}{|l|}{$1$}      & 1 623 192            & $2C_{w, b}+4D_{w,b} = 4$     & 7            & 03min 18sec        & 256     & $1^{-4}$             &23min 10sec           \\ 
