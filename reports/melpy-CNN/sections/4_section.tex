...
\captionof{figure}{Exemples d'images provenant du dataset MNIST}
\hfill\break
...
\captionof{figure}{Exemples d'images provenant du dataset CIFAR-10}
\hfill\break
...
\captionof{figure}{La précision globale des modèles calculées à la fin de chaque époque}
\hfill\break
...
Comme illustré dans la Figure 13, le réseau de neurones débute par une couche de convolution générant 32 cartes de caractéristiques, suivie d’une couche de pooling réduisant leur taille de moitié. 
...
Comme le montrent les Figures 12 et 13, les modèles 3, 7 et 8 se démarquent comme 
...
\captionof{figure}{Comparaison du coût entre Melpy et Keras}
\hfill\break
...
la somme des erreurs peut atteindre jusqu’à 1800, contre des valeurs inférieures à 0 pour les autres opérations. 
