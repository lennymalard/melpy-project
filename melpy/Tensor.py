...
class _Power(Operation):
    ...
    def __call__(self):
        ...
        self.output = Tensor(
            np.power(
                np.clip(x1_array, 1e-300, 1e300),
                np.clip(x2_array, None, 700),
    ...
    def backward(self, grad):
        ...
        self._apply_grad(self.x2, grad *
                        ...
                        np.log(np.clip(x1_array, 1e-300, None))
        )
